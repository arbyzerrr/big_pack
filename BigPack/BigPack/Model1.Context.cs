...
namespace BigPack
{
    ...
    public partial class PACKEntities : DbContext
    {
        private static PACKEntities _context;
        public PACKEntities()
            : base("name=PACKEntities")
        {
        }

        public static PACKEntities GetContext()
        {
            if (_context == null)
                _context = new PACKEntities();
